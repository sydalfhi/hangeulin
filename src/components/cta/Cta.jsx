  ...
  return (
    <section className="flex flex-col lg:flex-row mt-[90px] w-full rounded-[10px] bg-[#F4C237]  p-[48px]">
      <div className="flex flex-col items-start justify-center space-y-6">
        <h1 className="font-semibold popins text-[32px] mx-auto lg:mx-0">
          {data.title}
        </h1>
        <p className="text-base  mx-w-[590px]  md:max-w-[500px] lg:w-[590px] md:mx-auto lg:mx-0 leading-6 popins font-normal text-center lg:text-left">
          {data.desk}
        </p>
      </div>
